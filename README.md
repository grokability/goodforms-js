...
<script src='https://unpkg.com/goodforms@0.9.3'></script>
```
...
Or you can try:
```js
requirejs(['https://unpkg.com/goodforms@0.9.3'], function (Goodforms) {
...
The associated form, will have any and all submit buttons disabled until the email field is marked as valid. Submit
buttons are:
